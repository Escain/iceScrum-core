...
public class MethodScrumExpressionRoot extends SecurityExpressionRoot {
    ...
    public boolean Oauth2HasAnyScope(String... scopes) { return OAuth2Support.hasAnyScope(getAuthentication(), scopes); }
    ...
    public boolean inProject(Map p) {
        return securityService.inProject(p != null ? p.get("id") : null, getAuthentication());
    }
    ...
    public boolean productOwner(Map p) {
        return securityService.productOwner(p != null ? p.get("id") : null, getAuthentication());
    }
    ...
    public boolean stakeHolder(long p) {
        return securityService.stakeHolder(p, getAuthentication(), false);
    }

    public boolean stakeHolder(Map p) {
        return securityService.stakeHolder(p != null ? p.get("id") : null, getAuthentication(), false);
    }
    ...
    public boolean stakeHolder(Project p, boolean onlyPrivate) {
        return securityService.stakeHolder(p, getAuthentication(), onlyPrivate);
    }
    ...
    public boolean stakeHolder(Map p, boolean onlyPrivate) {
        return securityService.stakeHolder(p != null ? p.get("id") : null, getAuthentication(), onlyPrivate);
    }
